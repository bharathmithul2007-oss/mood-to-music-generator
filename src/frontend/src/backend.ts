...
export class Backend implements backendInterface {
    ...
    async getAvailableMoods(): Promise<Array<string>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAvailableMoods();
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getSongsByLanguage(arg0: string): Promise<Array<Song>> {
        if (this.processError) {
            try {
                const result = await this.actor.getSongsByLanguage(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getSongsByMood(arg0: string): Promise<Array<Song>> {
        if (this.processError) {
            try {
                const result = await this.actor.getSongsByMood(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
